...
public class AppRate {
    private final static String APP_TITLE = "Afaan Oromoo Kutaa 5ffaa Akka Afaan Lammaffaati";// App Name
    private static final String APP_PNAME = "com.beckytech.afaanoromookutaa5ffaaakkaafaanlammaffaati";// Package Name
